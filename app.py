...
data = load_data('https://github.com/adityapotdar23/4-Nearest-Coders_Datahack/raw/main/Dataset/dataset_temp.csv') 

# data_for_range = pd.read_csv('./Dataset/final_data.csv')

data_for_range = load_data('https://github.com/adityapotdar23/4-Nearest-Coders_Datahack/raw/main/Dataset/final_data.csv') 
# st.dataframe(data) 
...
def analyzer_brand(brand):
    ...
    df = load_data('https://github.com/adityapotdar23/4-Nearest-Coders_Datahack/raw/main/Dataset/train-new-car-dataset.csv')
